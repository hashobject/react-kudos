	  ...
	  render: function(){
	    return (
	      React.createElement("div", null, 
	        React.createElement(Kudos, {firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter4"}), 
	        React.createElement(Kudos, {allowMultiple: true, firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter6"})
	      )
	    )
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Kudos = React.createClass({displayName: "Kudos",
	  ...
	  render: function () {
	    return (
	      React.createElement("button", {onClick: this.handleClick}, this.state.counterValue)
	    )
	  }
