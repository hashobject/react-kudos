...
/***/ function(module, exports, __webpack_require__) {
	...
	var Kudos = __webpack_require__(1);
	  ...
	  render: function(){
	    return (
	      React.createElement("div", null, 
	        React.createElement(Kudos, {isButton: true, firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter4"}), 
	        React.createElement(Kudos, {isButton: true, allowMultiple: true, firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter6"}), 
	        React.createElement(Kudos, {isButton: true, firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter7"})
	      )
	    )
	  }
	});
	...
	var Kudos = React.createClass({displayName: "Kudos",
	  ...
	  render: function () {
	    ...
	    if (this.props.isButton) {
	      rendered = React.createElement("button", {onClick: this.handleClick}, this.state.counterValue);
	    } else {
	      rendered = React.createElement("div", {onClick: this.handleClick}, this.state.counterValue);
	    }
	    return (
	      React.createElement("div", null, 
	        rendered
